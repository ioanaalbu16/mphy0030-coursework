...
% Plot the surfaces in separate figures using handles to set properties:
figure(1); hold on; 
h(1) = trisurf(dt10, x10(1, :), x10(2, :), x10(3, :));

% Handles use again to increase size of font of title for a better
% visualisation:
h(2) = title('Ellipsoid surface of the 10th percentile probability density');
set(h(2), 'FontSize', 15);
