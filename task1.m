...
% Plot data using handles to set figure properties:
    h(i) = imshow(picture, [low, high]);
    
% Use handles to increase size of font of title for a better visualisation:
    h(i) = title('Random Slice ' + string(i));
    set(h(i), 'FontSize', 15);
